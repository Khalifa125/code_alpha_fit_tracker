                  ...
                  children: [
                    GestureDetector(
                      onTap: () => Navigator.push<void>(context,
                        MaterialPageRoute<void>(builder: (_) => const MapWorkoutScreen())),
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.map_rounded, color: FitColors.neonGreen, size: 18.sp),
                            SizedBox(width: 4.w),
                            Text('GPS', style: TextStyle(color: FitColors.neonGreen, fontSize: 12.sp, fontWeight: FontWeight.w600)),
                          ],
                        ),
                      ),
                    ),
              ...
              itemBuilder: (_, i) {
                ...
                return GestureDetector(
                  onTap: () => Navigator.push<void>(
                    context,
                    PageRouteBuilder(
                      pageBuilder: (_, __, ___) => CategoryScreen(category: labels[i]),
              ...
              children: [
                ...
                if (todayPlan != null) ...[
                  ...
                  GestureDetector(
                    onTap: () => Navigator.push<void>(
                      context,
                      PageRouteBuilder(
                        pageBuilder: (_, __, ___) => WorkoutDetailsScreen(workout: todayPlan),
                        transitionsBuilder: (_, animation, __, child) {
                    ...
                    child: _TodayPlanBanner(plan: todayPlan),
                  ),
                ...
                Row(children: [
                  Expanded(child: _CategoryCard(
                    ...
                    emoji: '🏋️',
                    onTap: () => Navigator.push<void>(context, MaterialPageRoute(builder: (_) => const CategoryScreen(category: 'Strength'))),
                  )),
                  SizedBox(width: 10.w),
                  Expanded(child: _CategoryCard(
                    label: 'Cardio',
                    ...
                    emoji: '🏃',
                    onTap: () => Navigator.push<void>(context, MaterialPageRoute(builder: (_) => const CategoryScreen(category: 'Cardio'))),
                  )),
                ]),
                ...
                Row(children: [
                  Expanded(child: _CategoryCard(
                    ...
                    emoji: '🧘',
                    onTap: () => Navigator.push<void>(context, MaterialPageRoute(builder: (_) => const CategoryScreen(category: 'Yoga'))),
                  )),
                  SizedBox(width: 10.w),
                  Expanded(child: _CategoryCard(
                    label: 'HIIT',
                    ...
                    emoji: '⚡',
                    onTap: () => Navigator.push<void>(context, MaterialPageRoute(builder: (_) => const CategoryScreen(category: 'HIIT'))),
                  )),
                ]),
                SizedBox(height: 24.h),
...
class _CategoryCard extends StatelessWidget {
  const _CategoryCard({required this.label, required this.color, required this.emoji, required this.onTap});
  final String label;
  final Color color;
  final String emoji;
